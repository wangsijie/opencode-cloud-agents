 ...
 * because it sits inside a 12px chip.
 */
...
/**
 * The sandbox host, when it is Docker: containers stacked on the whale's back,
 * drawn as a silhouette at the size of the header's other icons. The official
 * mark's face and its four rows of boxes are illegible this small, so this is
 * the shape rather than the logo — filled, because an outline at 18px closes
 * up into a smudge.
 */
  ...
  return (
    <Icon size={18}>
      <g fill="currentColor" stroke="none">
        {/* The stacked cargo, sitting on the deck line at y=12.8. */}
        <rect x="3.4" y="9.4" width="3.4" height="3.4" rx="0.4" />
        <rect x="7.2" y="9.4" width="3.4" height="3.4" rx="0.4" />
        <rect x="11" y="9.4" width="3.4" height="3.4" rx="0.4" />
        <rect x="7.2" y="5.6" width="3.4" height="3.4" rx="0.4" />
        {/* The body, and the tail fluke closing on the body's own right edge so
            the two fills meet rather than leaving a seam. */}
        <path d="M1.4 12.8h17c.2 1.7-.4 3.2-1.8 4.4-1.4 1.2-3.4 1.8-5.9 1.8-2.8 0-5.2-.8-6.9-2.3-1.7-1.5-2.4-2.8-2.4-3.9z" />
        <path d="M16.6 14.4c2.1-2.4 4.1-3.4 5.9-3.1.5 1.9.1 3.4-1.3 4.6-1.3 1.2-2.9 1.6-4.6 1.3z" />
      </g>
    </Icon>
  );
}
